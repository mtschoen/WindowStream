...
public class PipelineEventTests
{
    ...
    {
        System.Exception exception = new("capture boom");
    ...
    {
        System.Exception exception = new("encode boom");
    ...
    {
        System.Exception exception = new("probe boom");
    ...
    {
        System.Exception exception = new("enum boom");
