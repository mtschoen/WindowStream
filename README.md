...
Launch the **WindowStream Viewer** icon. The viewer auto-discovers and connects to the server on your LAN; tap the drawer toggle (≡) or plus
button (+) in the tab bar to select and open PC windows.
